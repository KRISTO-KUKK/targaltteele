...
export function fallbackTestAnalysis(kind: "interests" | "skills", message?: string): TestAnalysis {
  return {
    scores: [],
    tags: [],
...
export function fallbackFreeTextAnalysis(text: string, message?: string): FreeTextAnalysis {
...
export function fallbackProfileSummary(payload?: unknown, message?: string): ProfileSummary {
